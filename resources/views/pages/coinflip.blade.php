				...
				<div class="game-block">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Мин. сумма: <span id="minBet">{{$settings->flip_min_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Макс. сумма: <span id="maxBet">{{$settings->flip_max_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
					</div>
                                            ...
                                            <div class="game-coin flip_{{$rl['id']}}">
                                                <div class="top">
                                                    ...
                                                    <div class="right">
                                                        <div class="players block">
                                                            <div class="user">
                                                                <button type="button" class="btn btn-primary btn-join" data-id="{{$rl['id']}}"><span>Вступить</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td>
									<button class="btn btn-primary checkGame" data-hash="{{$end->hash}}">Проверить</button>
								</td>
							</tr>
							@endforeach
						</tbody>

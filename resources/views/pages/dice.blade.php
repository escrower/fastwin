						...
						<div class="game-area">
							<div class="progress-wrap">
								<div class="progress-item left">
									<div class="title">Мин. сумма: <span id="minBet">{{$settings->dice_min_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
									<div class="title">Макс. сумма: <span id="maxBet">{{$settings->dice_max_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
								</div>
							</div>
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td><button class="btn btn-primary checkGame" data-hash="{{$g['hash']}}">Проверить</button></td>
							</tr>
							@endforeach
						</tbody>
					</table>

...
<div class="cont-b">
	<div class="ref">
		...
		<div class="code">
			...
			<div class="value">
				<input type="text" value="<?php echo e($u->user_id); ?>" id="userID" readonly="" style="text-align: center;border-color: #fff;height: 32px;background-color: #e8e8e8;border-radius: 25px;padding: 15px;outline: none;margin-bottom: 16px;border: 2px solid transparent;">

...
<div class="section">
    <div class="section-page">
        <div class="quest-banner affiliate">
            ...
            <div class="info"><span>Зарабатывайте <?php echo e($settings->ref_perc); ?>% от суммы выигрыша вашего реферала.</span></div>
            <div class="info"><span>Ваши рефералы получают <?php echo e($settings->ref_sum); ?> бонусов при регистрации!</span></div>
        </div>
                ...
                <div class="affiliate-stats-item full">
                    <div class="wrap">
                        <div class="block">
                            ...
                            <span id="withdraw-button" class="" data-toggle="tooltip" data-placement="top" title="Минимальная сумма снятия <?php echo e($settings->min_ref_withdraw); ?> монет"><button type="button" <?php echo e($u->ref_money < $settings->min_ref_withdraw  ? 'disabled' : ''); ?> class="btn">Забрать</button></span>
                        </div>
                    </div>
                </div>
            </div>

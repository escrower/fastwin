            ...
            <div class="dailyFree_free">
                    ...
                    <div class="form_info">
                        <div class="form_wrapper group" style="display: none">
                        	<div class="form_text">
								...
								<br><span>и получайте до <strong><?php echo e($max); ?> монет на счет</strong></span>
                        	</div>
                ...
                <div class="list_list">
                    <div class="list_item group" data-bonus="group">
                        ...
                        <div class="list_text"><span>Вступите в нашу группу вк</span> <span>и получайте до <strong><?php echo e($max); ?> монет на счет</strong></span> <span>раз в <?php echo e($settings->bonus_group_time); ?> мин</span></div>
                    </div>

		...
		<div class="kt-portlet__body">
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="dtable">
				...
				<tbody>
					...
					<tr>
						<td><?php echo e($b->type == 'group' ? 'Группа' : 'Рефералы'); ?></td>
						...
						<td><a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Редактировать" data-toggle="modal" href="#edit_<?php echo e($b->id); ?>"><i class="la la-edit"></i></a><a href="/admin/bonus/delete/<?php echo e($b->id); ?>" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Удалить"><i class="la la-trash"></i></a></td>
					</tr>

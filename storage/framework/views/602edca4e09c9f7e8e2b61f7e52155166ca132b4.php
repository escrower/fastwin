			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="dtable">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo e($withdraw['system']); ?> (Вывод: <?php echo e(($withdraw['system'] == 'payeer') ? 'Payeer' : 'Free-Kassa'); ?>)</td>
						<td><?php echo e($withdraw['wallet']); ?></td>
						<td><div class="row text-center"><div class="col-md-6"><a href="/admin/withdraw/<?php echo e($withdraw['id']); ?>" class="btn btn-success btn-sm">Подтвердить</a></div><div class="col-md-6"><a href="/admin/return/<?php echo e($withdraw['id']); ?>" class="btn btn-danger btn-sm">Отменить</a></div></div></td>
					</tr>
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="dtable2">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo e($finish['system']); ?> (Вывод: <?php echo e(($finish['system'] == 'payeer') ? 'Payeer' : 'Free-Kassa'); ?>)</td>
